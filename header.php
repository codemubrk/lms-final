...
if (is_admin_login()) {
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color: #1a1b4b;">
            <!-- Navbar Brand-->
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" style="background-color: #1a1b4b;" id="sidenavAccordion">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            if (is_user_login()) {
                                                ...
                                                <ul class="list-inline mt-4 float-end">
                                                    ...
                                                    <li class="list-inline-item"><a href="issue_book_details.php">Issue Book</a>
                                                    </li>
